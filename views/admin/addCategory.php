...
if (isset($_POST["submit"])) {
    $result = new CategoriesController();
    $result->addCategory();
}
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                    ...
                    <div class="container mx-auto px-6 py-8">
                        <h3 class="text-gray-700 text-3xl font-medium">Add Category</h3>
                            ...
                            <div class="mx-auto max-w-md px-6 py-12 bg-[#F4FAFF] border-0 shadow-lg sm:rounded-3xl">
                                ...
                                <form method="post">
                                    <div class="relative z-0 w-full mb-5">
                                        <input type="text" name="name_category" placeholder=" " required class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent  border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                                        <label for="name_category" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">Enter Category name</label>
                                        <span class="text-sm text-red-600 hidden" id="error">Category is required</span>
                                    </div>
