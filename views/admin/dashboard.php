                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                        <div class="flex items-center">
                                                            ...
                                                            <div class="ml-4">
                                                                <div class="text-sm leading-5 font-medium text-gray-900"><?php echo $order_list["first_name"] ?>
                                                                </div>
                                                                <div class="text-sm leading-5 text-gray-500"><?php echo $order_list["last_name"] ?></div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                        <span class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 text-gray-500"><?php echo $order_list["quantity"] ?></span>
                                                    </td>
