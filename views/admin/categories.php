            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                    <div class="container mx-auto px-6 py-8">
                        ...
                        <div class="mt-5">
                            <a href="<?php echo BASE_URL; ?>addProduct" class="border border-[#947057] bg-[#947057] text-white rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:bg-[#603a20] focus:outline-none focus:shadow-outline">Add Category</a>
                                            ...
                                            <tbody class="bg-white">
                                                <tr>
                                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                        <div class="text-sm leading-5 text-gray-900"><?php echo $category['name_category']; ?></div>
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
