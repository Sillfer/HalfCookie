            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                    ...
                    <div class="container mx-auto px-6 py-8">
                        ...
                        <div class="mt-5">
                            <a href="<?php echo BASE_URL; ?>addCategory" class="border border-[#947057] bg-[#947057] text-white rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:bg-[#603a20] focus:outline-none focus:shadow-outline">Add Category</a>

                        </div>
                        <form id="delete_cat_Form" action="<?php echo BASE_URL ?>deleteCategory" method="post">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-no-wrap text-center border-b border-gray-200 text-sm leading-5">
                                                        <button type="button" class="text-white bg-red-700 hover:bg-red-800 transition duration-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2">
                                                            <a onclick="deleteCat(<?php echo $category['id_category']; ?>)">
