...
<div class="container px-4 py-5 text-center">
    <h2 class="pb-2 border-bottom text-center" style="color: #947057;">About Us</h2>
</div>
<div class="container px-4 py-5 text-center">
    <p class="text-center">
        <img src="views\assets\images\pages\home-bakery-business-productivity-1080x675.jpg" alt="About Us" class="img-fluid">
    </p>
    ...
    <p class="text-start fs-5" style="color: #947057;">
    HalfCookie recipes are hand-mixed and baked in small batches.  
    You will find only the very best 100% natural ingredients in every delicious flavor - 
    no preservatives or artificial flavors - no trans fats.  The cocoa and chocolate is the same used by 
    the most admired Chefs and Pastry Chefs.  We use gourmet spice blends, select dried fruits and premium quality nuts.  
    All combined to create rich, deep, satisfying flavors.
    </p>
    <p class="text-start fs-5" style="color: #947057;">
